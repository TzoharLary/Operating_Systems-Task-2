...
// Example 1: Running `mync` with both input and output from a TCP server
// ./mync -b TCPS4050
// To run this, first open a new terminal and run the command:
// ./mync -b TCPS4050
// Then, open another terminal and connect to the TCP server on port 4050:
// nc localhost 4050
// Enter input in the second terminal and check if it appears in the first terminal and vice versa.

// Example 2: Running `mync` with input from a TCP server
// ./mync -i TCPS4050
// To run this, first open a new terminal and run the command:
// ./mync -i TCPS4050
// Then, open another terminal and connect to the TCP server on port 4050:
// nc localhost 4050
// Enter input in the second terminal and check if it appears in the first terminal.

// Example 3: Running `mync` with output to a TCP client
// ./mync -o TCPClocalhost,4050
// To run this, first open a new terminal and start listening on port 4050:
// nc -l 4050
// Then, run the following command in the original terminal:
// ./mync -o TCPClocalhost,4050
// Enter input in the first terminal and check if it appears in the second terminal.
